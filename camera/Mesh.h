...
public:
	...
	int objectsCount() const { return objectsIndexes.size(); };

	const std::vector<glm::vec3>& getVertices() const { return vertices; }
	const std::vector<glm::vec3>& getNormals() const { return normals; }
	const std::vector<glm::vec3>& getColors() const { return colors; }
	const std::vector<glm::vec2>& getObjectsIndexes() const { return objectsIndexes; }

private:
	std::vector<glm::vec3> vertices;
	std::vector<glm::vec3> normals;
	std::vector<glm::vec3> colors;
	std::vector<glm::vec2> objectsIndexes;
};
